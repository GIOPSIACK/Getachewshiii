  ...
  return (
    <div className="flex flex-col flex-1 pb-safe">
      ...
      <div className="sticky top-0 z-40 bg-background/80 backdrop-blur-xl border-b border-border/40 px-4 py-3">
        ...
        <h1 className="text-2xl font-extrabold mb-0.5" style={{ fontFamily: "'Highstories', sans-serif", letterSpacing: "0.05em" }}>
          My Tickets
        </h1>
      ...
      {searchedPhone && !ticketsLoading && tickets?.length === 0 && (
        <div className="mx-4 mt-4 text-center p-8 bg-card rounded-3xl border border-dashed border-border animate-in fade-in">
          ...
          <h3 className="font-bold text-lg mb-1" style={{ fontFamily: "'Highstories', sans-serif", letterSpacing: "0.05em" }}>
            No tickets found
          </h3>
